...
<head>
  ...
  <title>MEDIOS PUBLICITARIOS</title>
    ...
    <div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
              Chrisstian René Cárdenas Sánchez <span class="caret"></span>
            </a>
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('home') }}" class="brand-link">
          <img src="{{ asset('images/AdminLTELogo.png') }}" alt="Empresa" class="brand-image img-circle elevation-3">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <!-- Add icons to the links using the .nav-icon class with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                  <a href="{{ url('otro_cliente') }}" class="nav-link">
                    <p>VENTAS</p>
                  </a>
                </li>
